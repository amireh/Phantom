local process = function(inCaster, inTarget, inSpell)
	Pixy.Log("I'm summoning a Skelly: Peasant!")
  ...
  local unit = Instance:create_unit("Skelly Peasant", inCaster)
...
--~
    --~ apply_spell_cost(inSpell, inCaster, nil, evt)
--~
...
subscribe_spell("Summon: Skelly Peasant", process)
